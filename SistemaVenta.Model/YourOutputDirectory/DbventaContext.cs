...
namespace SistemaVenta.Model.YourOutputDirectory;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=localhost\\SQLEXPRESS01;Database=DBVENTA;Trusted_Connection=True;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843F4F83486D");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF483A09E5295");
        ...
        {
            entity.HasKey(e => e.IdMenuRol).HasName("PK__MenuRol__9D6D61A42EE0C131");
        ...
        {
            entity.HasKey(e => e.IdNumeroDocumento).HasName("PK__NumeroDo__471E421A3AAAD394");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A1325E6F14EA");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A61107E5A6");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D56149FDC790B");
