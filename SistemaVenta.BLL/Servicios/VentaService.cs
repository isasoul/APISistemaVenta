...
namespace SistemaVenta.BLL.Servicios
{
	public class VentaService : IVentaService
	{
		...
		public VentaService(IVentaRepository ventaRepositorio, IGenericRepository<DetalleVenta> 
							detalleVentaRepositorio, IMapper mapper)
		{
		...
		public async Task<List<VentaDTO>> Historial(string buscarPor, string numeroVenta, string fechaInicio, string fechaFin)
		{
			...
			try
			{
				if (buscarPor == "fecha")
				{
					...
					DateTime fech_Fin = DateTime.ParseExact(fechaInicio, "dd/MM/yyyy", new CultureInfo("es-PER"));
